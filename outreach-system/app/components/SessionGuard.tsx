...
export default function SessionGuard() {
    ...
    useEffect(() => {
        ...
        const publicPaths = ['/login', '/register', '/signup', '/maintenance', '/', '/forgot-password', '/reset-password', '/auth-error', '/privacy', '/help', '/help/guide', '/guide', '/documentation', '/case-studies', '/api-status'];
