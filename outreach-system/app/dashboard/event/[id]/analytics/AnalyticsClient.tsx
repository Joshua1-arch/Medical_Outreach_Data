        ...
        <div className="space-y-8">
            ...
            <div className="flex justify-between items-center">
                ...
                <button
                    ...
                    disabled={analyzing}
                    className="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-slate-900 to-slate-700 text-white rounded-xl font-bold text-sm hover:from-slate-800 hover:to-slate-600 transition-all shadow-lg shadow-slate-900/20 group disabled:opacity-60 disabled:cursor-not-allowed"
                >
                    {analyzing ? (
                        <>
