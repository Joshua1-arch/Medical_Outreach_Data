        ...
        headers: [
          ...
          // Content Security Policy — tailored whitelist for ReachPoint
          {
            ...
            value: [
              ...
              "img-src 'self' data: blob: https://res.cloudinary.com https://medical-outreach-data-cdbh.vercel.app https://challenges.cloudflare.com",
              "connect-src 'self' https://*.pusher.com wss://*.pusher.com https://*.ably.io wss://*.ably.io https://rest.ably.io https://challenges.cloudflare.com https://api.paystack.co https://api.cloudinary.com https://va.vercel-scripts.com",
              "frame-src https://challenges.cloudflare.com https://js.paystack.co",
              "object-src 'none'",
              // Relaxed for Turnstile compatibility
              "base-uri 'self' https://challenges.cloudflare.com",
